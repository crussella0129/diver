...
- [ ] T-1701 (sprint 17) [intent: INT-0018]: common-word stoplist — stopwords.txt + LazyLock<HashSet> + significant_terms + tests + adjust stopped test fixtures — touches: diver-core/src/graph.rs, diver-core/src/stopwords.txt
