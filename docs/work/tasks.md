...
- [ ] T-1802 (sprint 18) [intent: INT-0019]: CLI subprocess test proving `open()` actually reads `DIVER_DB` — touches: diver-cli/tests/db_override.rs (new), diver-cli/Cargo.toml, Cargo.lock
