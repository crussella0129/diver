...
| ID | Title | State |
|----|-------|-------|
| [INT-0001](INT-0001-arxiv-search-cli.md) | ArXiv search CLI | realized |
...
| [INT-0014](INT-0014-weighted-coassertion-temperature.md) | Weighted co-assertion with adjustable temperature | planned |
